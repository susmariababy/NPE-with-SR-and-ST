...
## Utilities:
# to_tanh: transforms an array in the range [0,255] to the range [-1,1] linarly
# from_tanh: transforms an array in the range [-1,1] to the range[0,255] linearly
def to_tanh(input):
...
def make_training_functions(cfg,model):
    ...
    batch_slice = slice(batch_index*cfg['batch_size'], (batch_index+1)*cfg['batch_size'])	# slicing an array/list

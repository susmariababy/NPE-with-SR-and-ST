...
# default arguments
CONTENT_IMAGE = 'neural_style_master/content_img.jpg'
STYLES = ['neural_style_master/starry_style_img.jpg']
OUTPUT = 'neural_style_master/output_img.jpg'
CONTENT_WEIGHT = 5e0
...
EPSILON = 1e-08
STYLE_SCALE = 1.0
ITERATIONS = 1000  # changed from 1000
VGG_PATH = 'neural_style_master/imagenet-vgg-verydeep-19.mat'
POOLING = 'max'
...
def build_parser():
    ...
    parser.add_argument('--content',
            ...
            metavar='CONTENT' , default=CONTENT_IMAGE)		# , required=True)
    parser.add_argument('--styles',
            dest='styles',
            nargs='+', help='one or more style images',
            metavar='STYLE', default=STYLES)			# , required=True)
    parser.add_argument('--output',
            dest='output', help='output path',
            metavar='OUTPUT', default=OUTPUT)			# , required=True)
    ...
    parser.add_argument('--width', type=int,
            ...
            metavar='WIDTH')     #, default = 64)   # default width added by me
